...
export default function Home() {
	...
	const { experiences, isLoading: experiencesLoading, loadingMessage: experiencesLoadingMessage } = useExperiences();
	const { articles, isLoading: articlesLoading, loadingMessage: articlesLoadingMessage } = useArticles();
	...
	useEffect(() => {
		const observer = new IntersectionObserver(
			(entries) => {
				...
				const currentSection = intersectingEntries.reduce((bestEntry, entry) => {
					...
					return entry.boundingClientRect.top < bestEntry.boundingClientRect.top ? entry : bestEntry;
				});
