...
const skillGroups: SkillGroup[] = [
    {
        label: "Frameworks",
        description:
            "The stack I reach for when I want to move fast without losing structure.",
    ...
    },
    {
        label: "Languages",
        description:
            "Languages I use to build product, systems, and tooling across the stack.",
    ...
    },
    {
        label: "Tools",
        description:
            "The editor, delivery, and API tooling that keeps my workflow tight.",
    ...
    },
    {
        label: "Cloud & DevOps",
        description:
            "Infrastructure and observability tools I am comfortable shipping with.",
            ...
            <div className="space-y-10 sm:space-y-14">
                ...
                <div className="gap-4 sm:gap-6 grid md:grid-cols-2">
                    {skillGroups.map((group) => (
                        ...
                        >
                            <div
                                className={`absolute inset-0 bg-linear-to-br ${group.accent} opacity-80`}
                            />
                            ...
                            <div className="relative space-y-5">
                                <div className="flex justify-between items-end gap-4">
                                    <div>
                                        ...
                                        <h3 className="mt-2 font-medium text-2xl sm:text-3xl">
                                            {group.label}
                                        </h3>
                                    </div>
